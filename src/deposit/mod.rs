...
pub async fn get_valid_beacon_node_http_client(
    ...
    spec: &ChainSpec,
) -> Result<BeaconNodeHttpClient, DvfError> {
...
pub fn get_deposit_test() {
    let sk = bls::SecretKey::deserialize(
        &hex::decode("12a660e5a304e3386c0fff53ced385faa25e305cc047aaac0b446f0c2053d4be").unwrap(),
    )
    .unwrap();
    ...
    let mut deposit_data = DepositData {
        ...
        withdrawal_credentials: Hash256::from_slice(
            &hex::decode("00076bd8b841544ab6335ae084849141dfd84155a1980d178ac1b96ef1040915")
                .unwrap(),
        ),
        amount: 32000000000,
        signature: Signature::empty().into(),
